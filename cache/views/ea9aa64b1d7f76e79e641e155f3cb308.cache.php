...
<div class="subnav">
    <div class="content-menu ib-a blue line-x">
        <a href="<?php echo url('admin/plugin'); ?>" class="on"><em><?php echo lang('dr015'); ?></em></a><span>|</span>
        <a href="<?php echo url('admin/plugin/online'); ?>"><em><?php echo lang('dr016'); ?></em></a><span>|</span>
...
function getViewData(pluginid) {
	...
	window.top.art.dialog(
	    {id:"ajaxview", okVal:fc_lang[6], cancelVal:fc_lang[7], iframe:url, title:'<?php echo lang('a-plu-37'); ?>', width:'260', height:'90', lock:true,
		button: [
            {
